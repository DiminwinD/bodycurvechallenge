    ...
    return (
      <div style={{ textAlign: "center", padding: 28, background: `${C.cta}06`, borderRadius: 20, marginTop: 16 }}>
        ...
        <div style={{ marginTop: 20 }}>
          <CTAButton onClick={() => { window.location.href = '/reservation'; }} full>Je bloque ma place maintenant</CTAButton>
        </div>
      </div>
    );
  }
...
function PricingCard({ promo }) {
  const scrollCTA = () => { window.location.href = '/reservation'; };
  const includes = [
...
export default function BodyCurveChallenge() {
  ...
  const scrollPricing = () => { window.location.href = '/reservation'; };
